...
Public Class create_profile
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            sqlstr = "insert into create_profile_G values('" & txt_fname.Text & "','" & txt_lname.Text & "','" & txt_mobno.Text & "','" & txt_height.Text & "','" & ComboBox1.SelectedItem.ToString & "','" & txt_mt.Text & "','" & txt_email.Text & "','" & txt_city.Text & "')"
    ...
    Private Sub create_profile_Load(sender As Object, e As EventArgs) Handles MyBase.Load
